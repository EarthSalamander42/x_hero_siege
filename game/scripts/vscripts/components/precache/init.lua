...
XHSPrecache:RegisterGroup("hero_abilities", {
	particles = {
		...
		"particles/custom/human/blood_mage/invoker_sun_strike_team_immortal1.vpcf",
		"particles/custom/human/blood_mage/invoker_sun_strike_team_immortal2.vpcf",
		"particles/custom/human/blood_mage/exort_orb.vpcf",
		"particles/econ/items/shadow_fiend/sf_fire_arcana/sf_fire_arcana_requiemofsouls_line_ground.vpcf",
		"particles/neutral_fx/black_dragon_fireball_lava_scorch.vpcf",
