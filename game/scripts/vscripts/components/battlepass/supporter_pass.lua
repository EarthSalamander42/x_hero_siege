...
function SupporterPass:BuildPlayerTable(playerID)
	...
	return {
		...
		show_companion = FirstSupporterValue(settings.show_companion, player.show_companion, current.show_companion, true),
		...
		starting_item_slots = FirstSupporterValue(settings.starting_item_slots, player.starting_item_slots, current.starting_item_slots),
