...
local COUNTER_NAMES = {
	...
	"creep_orders_wave",
	"wave_stage_jobs_started",
	"wave_stage_jobs_cancelled",
	"wave_stage_jobs_released",
	"wave_stage_units_created",
	"wave_stage_units_fallback_created",
	"wave_stage_units_released",
	"wave_stage_units_cancelled",
	"wave_stage_units_cleaned",
	"wave_stage_create_failures",
	"wave_stage_release_missing",
	"wave_stage_capacity_deferred",
	"wave_stage_create_cost_ms",
	"wave_stage_ai_wakes",
	"ai_thinks",
	"ai_director_ticks",
