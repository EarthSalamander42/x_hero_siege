...
local ITEMS = {
	item_health_potion = {
		...
		cooldown = 1,
		script_file = "items/item_health_potion",
		tags = { sustain = 1.0 },
	...
	item_mana_potion = {
		...
		backpack_usable = false,
		cooldown = 1,
		script_file = "items/item_mana_potion",
		tags = { mana = 1.0 },
		behavior = "instant_no_target",
		stacking = "charges",
	...
	item_xhs_cloak_of_flames = {
		...
		behavior = "passive_aura",
		stacking = "unique_aura",
	...
	item_boots_of_speed = {
		...
		default_penalty = 34,
		behavior = "passive",
		stacking = "unique_movement_speed",
	...
	item_healing_wards = {
		...
		cooldown = 20,
		cast_range = 500,
		script_file = "items/wards",
		tags = { sustain = 0.85, team = 0.75 },
		behavior = "instant_point",
		stacking = "charges",
		summoned_unit = "healing_ward",
		stats = {
			duration = 30,
			radius = 500,
			regeneration_pct = 0.5,
...
local EQUIP_ONLY_ITEMS = {
	...
	item_ring_of_superiority = {
		...
		stats = {
			...
			bat_reduction = 0.4,
			endurance_bonus_movement_speed = 20,
		},
	},
}
...
local FAMILIES = {
	...
	wind = {
		...
		levels = {
			{
				name = "item_orb_of_wind",
				cost = 10000,
				shop = "home",
				stats = {
					bonus_damage = 100,
					bonus_evasion_pct = 17,
					bonus_movement_speed = 40,
					evasion_proc_duration = 0,
					evasion_proc_cooldown = 0,
					evasion_proc_movespeed_pct = 0,
			...
			},
			{
				...
				stats = {
					bonus_damage = 300,
					bonus_evasion_pct = 25,
					bonus_movement_speed = 70,
					evasion_proc_duration = 2,
					evasion_proc_cooldown = 8,
					evasion_proc_movespeed_pct = 20,
					evasion_proc_damage_reduction_pct = 0,
				},
			},
			{
