...
XHSBotConfig.DIFFICULTIES = {
	easy = {
		...
		health_potion_large_health_start = 20000,
		health_potion_large_health_full = 80000,
		health_potion_large_health_threshold = 0.62,
		health_potion_danger_threshold = 0.58,
	...
	normal = {
		...
		health_potion_large_health_start = 20000,
		health_potion_large_health_full = 80000,
		health_potion_large_health_threshold = 0.70,
		health_potion_danger_threshold = 0.66,
