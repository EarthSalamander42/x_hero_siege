...
function XHSBots:PushDebugState()
	...
	for _, playerID in ipairs(XHSBotPlayerRegistry:GetXHSBotPlayerIDs()) do
		...
		CustomNetTables:SetTableValue("xhs_bots", "debug_" .. tostring(playerID), {
			...
			engagement_classification = record.engagement_classification or "",
			engagement_mode = record.engagement_mode or "",
			engagement_pack_count = record.engagement_pack_count or 0,
			engagement_enemy_count = record.engagement_enemy_count or 0,
			engagement_time_to_clear = record.engagement_time_to_clear or 0,
			engagement_time_to_die = record.engagement_time_to_die or 0,
			engagement_survival_ratio = record.engagement_survival_ratio or 0,
			engagement_feasibility = record.engagement_feasibility or 0,
			engagement_purchase_requested =
				record.engagement_purchase_requested == true and 1 or 0,
			engagement_purchase_reason = record.engagement_purchase_reason or "",
			engagement_help_requested =
				record.engagement_help_requested == true and 1 or 0,
			ultimate_reservation_reason = record.ultimate_reservation_reason or "",
			ultimate_reservations = record.ultimate_reservations or 0,
			...
			planned_purchase_queue = record.planned_purchase_queue or {},
			planned_suggestion_item = record.planned_suggestion_item or "",
			planned_suggestion_only =
				record.planned_suggestion_only == true and 1 or 0,
			planned_suggestion_reason = record.planned_suggestion_reason or "",
