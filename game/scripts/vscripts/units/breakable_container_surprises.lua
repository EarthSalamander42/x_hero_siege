...
function GameMode:ChooseBreakableSurprise( hAttacker, hBreakableEnt )
	...
	--[[
	if hAttacker then
		print( string.format( "GameMode:ChooseBreakableSurprise() - hAttacker: %s", hAttacker:GetUnitName() ) )
	end
	]]

	if hBreakableEnt.zone == nil then
		print( "GameMode:ChooseBreakableSurprise() -- WARNING: No zone found for this breakable. Defaulting to \"forest\"" )
		hBreakableEnt.zone = self:GetZoneByName( "forest" )
	end

	if hBreakableEnt.CommonItems == nil then
		print( "GameMode:ChooseBreakableSurprise() -- WARNING: No CommonItems table found for this breakable. Defaulting to branches." )
	...
	if hBreakableEnt.RareItems == nil then
		print( "GameMode:ChooseBreakableSurprise() -- WARNING: No RareItems table found for this breakable. Defaulting to clarity." )
	...
	if hBreakableEnt.nMinGold == nil then
		...
		print( string.format( "GameMode:ChooseBreakableSurprise() -- WARNING: Missing nMinGold value for this breakable. Setting it to: %.2f", hBreakableEnt.nMinGold ) )
	end

	if hBreakableEnt.nMaxGold == nil then
		hBreakableEnt.nMaxGold = 200
		print( string.format( "GameMode:ChooseBreakableSurprise() -- WARNING: Missing nMaxGold value for this breakable. Setting it to: %.2f", hBreakableEnt.nMaxGold ) )
	end

	if hBreakableEnt.fCommonItemChance == nil then
		hBreakableEnt.fCommonItemChance = 0.1
		print( string.format( "GameMode:ChooseBreakableSurprise() -- WARNING: No fCommonItemChance specified for this breakable. Setting it to %.2f", hBreakableEnt.fCommonItemChance ) )
	end

	if hBreakableEnt.fRareItemChance == nil then
		hBreakableEnt.fRareItemChance = 0.02
		print( string.format( "GameMode:ChooseBreakableSurprise() -- WARNING: No fRareItemChance specified for this breakable. Setting it to %.2f", hBreakableEnt.fRareItemChance ) )
	end

	if hBreakableEnt.fGoldChance == nil then
		hBreakableEnt.fGoldChance = 0.15
		print( string.format( "GameMode:ChooseBreakableSurprise() -- WARNING: No fGoldChance specified for this breakable. Setting it to %.2f", hBreakableEnt.fGoldChance ) )
	end
...
function GameMode:CreateBreakableContainerCommonItemDrop( hAttacker, hBreakableEnt )
...
function GameMode:CreateBreakableContainerRareItemDrop( hAttacker, hBreakableEnt )
...
function GameMode:CreateBreakableContainerGoldDrop( hAttacker, hBreakableEnt )
...
function GameMode:GetBreakableRewardSpawnPos( hBreakableEnt )
