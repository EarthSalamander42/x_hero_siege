...
table.insert(devour_table, "npc_dota_creature_mini_lifestealers")
table.insert(devour_table, "npc_dota_creature_mini_weavers")
table.insert(devour_table, "npc_dota_creature_mini_undyings")
table.insert(devour_table, "npc_dota_creature_mini_necrolytes")
table.insert(devour_table, "npc_dota_creature_mini_nyxes")
table.insert(devour_table, "npc_dota_creature_mini_fiends")
table.insert(devour_table, "npc_dota_creature_mini_dooms")
table.insert(devour_table, "npc_dota_creature_mini_black_dragons")
table.insert(devour_table, "npc_dota_creature_mini_lancers")
table.insert(devour_table, "npc_dota_creature_mini_miranas")
table.insert(devour_table, "npc_dota_creature_mini_tinys")
table.insert(devour_table, "npc_dota_creature_mini_wyverns")
