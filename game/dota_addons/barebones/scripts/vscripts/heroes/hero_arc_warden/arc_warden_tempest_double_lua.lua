...
--	function arc_warden_tempest_double_modifier:GetStrength()
--		return MODIFIER_ATTRIBUTE_PERMANENT
--	end
--	
--	function arc_warden_tempest_double_modifier:GetAgility()
--		return MODIFIER_ATTRIBUTE_PERMANENT
--	end
--	
--	function arc_warden_tempest_double_modifier:GetIntellect()
--		return MODIFIER_ATTRIBUTE_PERMANENT
--	end
