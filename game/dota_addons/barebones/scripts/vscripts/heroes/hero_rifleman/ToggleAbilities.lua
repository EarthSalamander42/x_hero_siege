function RocketLauncherAutoCast(event)
local caster = event.caster
local ability1 = caster:FindAbilityByName("holdout_rocket_launcher")
local ability2 = caster:FindAbilityByName("holdout_plasma_rifle")

	if ability1:GetAutoCastState() == true and ability1:GetAutoCastState() ~= ability2:GetAutoCastState() then
		return
	else
