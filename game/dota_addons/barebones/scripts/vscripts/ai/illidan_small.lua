...
function Spawn( entityKeyValues )
	Ability_negative_energy = thisEntity:FindAbilityByName("demonhunter_negative_energy_small")
	Ability_immolation = thisEntity:FindAbilityByName("demonhunter_immolation_small")
