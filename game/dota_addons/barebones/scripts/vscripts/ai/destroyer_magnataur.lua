...
function Spawn( entityKeyValues )
    ...
    behaviorSystem = AICore:CreateBehaviorSystem( { BehaviorNone, BehaviorThunderClapLow, BehaviorRunAway } ) 
end
...
BehaviorThunderClapLow = {}

function BehaviorThunderClapLow:Evaluate()
	local desire = 0
	...
	if #enemies > 0 then
		...
		if ABILITY_ThunderClapLow and ABILITY_ThunderClapLow:IsFullyCastable() then
			thisEntity:Stop()
			thisEntity:CastAbilityNoTarget( ABILITY_ThunderClapLow, -1 )
		end
	end
...
function BehaviorThunderClapLow:Begin()
	...
	self.order =
	{
		...
		AbilityIndex = ABILITY_ThunderClapLow:entindex(),
	}

end

BehaviorThunderClapLow.Continue = BehaviorThunderClapLow.Begin
...
AICore.possibleBehaviors = { BehaviorNone, BehaviorThunderClapLow, BehaviorRunAway }
