...
local delay = 3.0
	...
	Timers:CreateTimer(delay, function()
		...
		elseif difficulty == 4 then
			...
			magtheridon2:AddNewModifier(nil, nil, "modifier_pause_creeps", {Duration = 10, IsHidden = true})
		...
		magtheridon:AddNewModifier(nil, nil, "modifier_pause_creeps", {Duration = 10, IsHidden = true})
...
function StartArthasArena(keys)
	...
	arthas:AddNewModifier(nil, nil, "modifier_pause_creeps", {Duration = 10, IsHidden = true})
...
function StartBanehallowArena()
	...
	Timers:CreateTimer(8,function()
		...
		banehallow:AddNewModifier(nil, nil, "modifier_pause_creeps", {Duration = 26, IsHidden = true})
	...
	Timers:CreateTimer(12,function()
		...
		green_revenant2:AddNewModifier(nil, nil, "modifier_pause_creeps", {duration = 12, IsHidden = true})
	...
	Timers:CreateTimer(13.5,function()
		...
		green_revenant:AddNewModifier(nil, nil, "modifier_pause_creeps", {duration = 10.5, IsHidden = true})
		...
		green_revenant2:AddNewModifier(nil, nil, "modifier_pause_creeps", {duration = 10.5, IsHidden = true})
	...
	Timers:CreateTimer(15,function()
		...
		green_revenant:AddNewModifier(nil, nil, "modifier_pause_creeps", {duration = 9, IsHidden = true})
		...
		green_revenant2:AddNewModifier(nil, nil, "modifier_pause_creeps", {duration = 9, IsHidden = true})
	...
	Timers:CreateTimer(16.5,function()
		...
		green_revenant:AddNewModifier(nil, nil, "modifier_pause_creeps", {duration = 7.5, IsHidden = true})
		...
		green_revenant2:AddNewModifier(nil, nil, "modifier_pause_creeps", {duration = 7.5, IsHidden = true})
	...
	Timers:CreateTimer(18,function()
		...
		green_revenant:AddNewModifier(nil, nil, "modifier_pause_creeps", {duration = 5, IsHidden = true})
		...
		green_revenant2:AddNewModifier(nil, nil, "modifier_pause_creeps", {duration = 5, IsHidden = true})
	...
	Timers:CreateTimer(19.5,function()
		...
		green_revenant:AddNewModifier(nil, nil, "modifier_pause_creeps", {duration = 3.5, IsHidden = true})
		...
		green_revenant2:AddNewModifier(nil, nil, "modifier_pause_creeps", {duration = 3.5, IsHidden = true})
...
function StartSpiritMasterArena()
	...
	spirit_master:AddNewModifier(nil, nil, "modifier_pause_creeps", {Duration = start_time, IsHidden = true})
...
function StartSecretArena(hero)
	...
	Timers:CreateTimer(3.0, function()
		...
		secret:AddNewModifier(nil, nil, "modifier_pause_creeps", {Duration = 10, IsHidden = true})
