function SpawnCreeps()
	...
	local Waypoint = Entities:FindByName( nil, "creep_path_"..c)
		if CREEP_LANES[c] == 1 and BARRACKMENTS[c] == 1 and time_elapsed < 390 then -- Level 1 lower than 6 min
			for j = 1, 3 do
			...
			unit:SetInitialGoalEntity(Waypoint)
			unit:MoveToPositionAggressive(Waypoint:GetAbsOrigin())
		elseif CREEP_LANES[c] == 1 and BARRACKMENTS[c] == 1 and time_elapsed >= 390 and time_elapsed < 750 then -- Level 2, 6 to 14 Min
			for j = 1, 4 do
		...
		elseif CREEP_LANES[c] == 1 and BARRACKMENTS[c] == 1 and time_elapsed >= 870 and time_elapsed < 1230 then -- Level 3, 14 to 20 Min
			for j = 1, 5 do
		...
		elseif CREEP_LANES[c] == 1 and BARRACKMENTS[c] == 1 and time_elapsed >= 1230 and time_elapsed < 1470 then -- Level 4, 20 to 24 Min
			for j = 1, 5 do
		...
		elseif CREEP_LANES[c] == 1 and BARRACKMENTS[c] == 1 and time_elapsed >= 1650 and time_elapsed < 1830 then -- Level 4, 27 to 30 Min
			for j = 1, 5 do
				local unit = CreateUnitByName("npc_dota_creature_mini_dooms", point:GetAbsOrigin(), true, nil, nil, DOTA_TEAM_BADGUYS)
				unit:SetInitialGoalEntity(Waypoint)
				unit:MoveToPositionAggressive(Waypoint:GetAbsOrigin())
		...
		elseif CREEP_LANES[c] == 1 and BARRACKMENTS[c] == 1 and time_elapsed >= 1830 and time_elapsed < 2190 then -- Level 5, 30 to 36 Min
			for j = 1, 5 do
		...
		elseif CREEP_LANES[c] == 1 and BARRACKMENTS[c] == 1 and time_elapsed >= 2190 then -- Level 6, 36 to Infinite.
			for j = 1, 5 do
