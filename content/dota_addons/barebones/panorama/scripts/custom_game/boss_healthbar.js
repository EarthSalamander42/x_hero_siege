...
function ShowBossBar(args) {
	...
	$("#BossProgressBar_Left").style.backgroundColor = "gradient( linear, 0% 0%, 0% 100%, from( " + args.light_color + " ), color-stop( 0.3, " + args.dark_color + " ), color-stop( .5, " + args.light_color + " ), to( " + args.dark_color + " ) )";
}
