...
(function UpdatePartyHealthBars()
{
	...
	for ( i; i < 8; i++ )
	{
		...
		if ( playerPanel === null )
		{
			...
			var HeroNameLabel = playerPanel.FindChildInLayoutFile( "HeroName" );
			HeroNameLabel.text = Players.GetPlayerSelectedHero( playerID );
			HeroNameLabel.style.color = colorString;
		}
