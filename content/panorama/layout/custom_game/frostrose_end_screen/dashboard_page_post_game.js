...
//		var player_damage_received_row_container = $("#" + team_name[team_number] + "DamageReceivedRows");
		...
		panel_support_item.BLoadLayout("file://{resources}/layout/custom_game/frostrose_end_screen/dashboard_page_post_game_abilities_row_legend.xml", false, false);
...
//		if (Game.GetTeamDetails(team_number).team_num_players > 0) {
			...
			$("#" + team_name[team_number] + "PlayerRowLegend").BLoadLayout("file://{resources}/layout/custom_game/frostrose_end_screen/dashboard_page_post_game_row_legend.xml", false, false);
...
//				$.Msg(player_result)
				...
				PinnedPlayerRow.BLoadLayout("file://{resources}/layout/custom_game/frostrose_end_screen/dashboard_page_post_game_pinned_player_row.xml", false, false);
				...
				PlayerRowContainer.BLoadLayout("file://{resources}/layout/custom_game/frostrose_end_screen/dashboard_page_post_game_row.xml", false, false);
...
*/
				...
				panel_kill_matrix_row.BLoadLayout("file://{resources}/layout/custom_game/frostrose_end_screen/dashboard_page_post_game_kill_matrix_row.xml", false, false);
...
//					$.Msg(iteration + " / " + panel_kill_matrix_row.FindChildTraverse("VictimHero" + iteration))
				...
				panel_support_items_row.BLoadLayout("file://{resources}/layout/custom_game/frostrose_end_screen/dashboard_page_post_game_support_items_row.xml", false, false);
				...
				if (player_result) {
					if (player_result.support_items) {
						for (var item_id in player_result.support_items) {
							...
							panel_support_item.BLoadLayout("file://{resources}/layout/custom_game/frostrose_end_screen/dashboard_page_post_game_support_items_item_entry.xml", false, false);
					...
					panel_abilities.BLoadLayout("file://{resources}/layout/custom_game/frostrose_end_screen/dashboard_page_post_game_abilities_row.xml", false, false);
